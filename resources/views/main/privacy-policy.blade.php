        ...
        <div class="row align-items-center">
            <div class="col-12 col-sm-8 col-md-7">
                <div class="banner-content">
                    <h1 class="heading banner-title banner-title-b">Privacy Policies</h1>
...
<section class="pt-6 pb-6 bg-light">
    <div class="container">
        <h1 class="f-600">Privacy Policy</h1>
        ...
        <h1 class="f-600">Collecting and Using Your Personal Data</h1>
        ...
        <ul>
            ...
            <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash
                ...
                disabling, or deleting local shared objects?&quot; available at <a
                    ...
                    rel="external nofollow noopener" target="_blank">helpx.adobe.com</a></li>
        ...
        <h1 class="f-600">Changes to this Privacy Policy</h1>
