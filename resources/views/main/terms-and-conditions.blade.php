        ...
        <div class="row align-items-center">
            <div class="col-12 col-sm-8 col-md-7">
                <div class="banner-content">
                    <h1 class="heading banner-title banner-title-b">Terms and Conditions</h1>
                    <p class="p banner-subtitle">VNC Digital Services - Technology Simplified</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="pt-6 pb-6 bg-light">
    <div class="container">
        <h1 class="f-600">Terms and Conditions</h1>
        <p>Last updated: December 07, 2020</p>
        <p>Please read these terms and conditions carefully before using Our Service.</p>
        <h1 class="f-600">Interpretation and Definitions</h1>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to VNC Digital Services Pvt. Ltd,
                    Bangalore, India.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to VNC Digital Services, accessible from <a
                        href="https://www.vncdigitalservices.com/" rel="external nofollow noopener"
                        target="_blank">https://www.vncdigitalservices.com/</a></p>
            </li>
            <li>
        ...
        <h1 class="f-600">Acknowledgment</h1>
        ...
        <p>Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the
            ...
            using Our Service.</p>
        <h1 class="f-600">Links to Other Websites</h1>
        ...
        <h1 class="f-600">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
        ...
        <p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the
            ...
            laws.</p>
        <h1 class="f-600">Disputes Resolution</h1>
        ...
        <h1 class="f-600">For European Union (EU) Users</h1>
        ...
        <h1 class="f-600">United States Legal Compliance</h1>
        ...
        <h1 class="f-600">Severability and Waiver</h1>
        <h2>Severability</h2>
        ...
        <h1 class="f-600">Translation Interpretation</h1>
        <p>These Terms and Conditions may have been translated if We have made them available to You on our Service.
            You agree that the original English text shall prevail in the case of a dispute.</p>
        <h1 class="f-600">Changes to These Terms and Conditions</h1>
        ...
        <p>By continuing to access or use Our Service after those revisions become effective, You agree to be bound by
            ...
            and the Service.</p>
        <h1 class="f-600">Contact Us</h1>
        <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
        <ul>
            <li>By email: info@vncdigital.com</li>
        </ul>
